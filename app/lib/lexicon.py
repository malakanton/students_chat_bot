...
PUSHING_CHANGE = """
Чтобы поменять время или отключить ежедневные уведомления нажми одну из кнопок ниже:
"""

#TODO: поменять формулировку
PUSHING_ON = """
Чтобы установить время ежедневных уведомлений или оставить их выключенными нажми на одну из кнопок ниже:
"""
