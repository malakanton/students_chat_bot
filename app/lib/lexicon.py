...
Обращаю твое внимание, что сообщения приходят только по будням.
"""

PUSH_TIME_MESSAGE = """Введи время в формате HH:MM"""

PUSH_TIME_SET = """Ты установил время {}"""

INVALID_PUSH_TIME = """Неверный формат времени, попробуй еще раз"""

PUSHING_CHANGE = """
Ежедневные оповещения будут приходить в установленное тобой время. Они помогут спланировать свой день и не опоздать на пары:
"""
...
Я напомню тебе о занятии за выбранное количество минут ниже:
"""

NOTIFICATIONS_ON_OFF_END = """
Чтобы изменить настройку необходимых уведомлений, введи команду /notifications
"""

NOTIF_FLAG = [
    '🔴Напоминалка перед парой - ОТКЛ',
    '🟢Напоминалка перед парой - ВКЛ (за {} минут) '
]

NOTIF_PUSH = [
    '🔴Ежедневные оповещения - ОТКЛ',
    '🟢Ежедневные оповещения - ВКЛ (в {})'
]
